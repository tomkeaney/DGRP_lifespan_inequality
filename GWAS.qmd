...
`Yeast_percentage`: the overall % of the food recipe made up by brewers yeast. This is a common ingredient in _Drosophila_ food, and the key source of protein. Several studies in our dataset were specifically interested in restriction of protein availability as a method to extend lifespan.  
...
# Investigating the genetic correlation between e0 and h

## Generating predictions through simulation
...
## Using the residual genotypic values
